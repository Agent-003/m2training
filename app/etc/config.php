...
return [
    'modules' => [
        ...
        'Training_TestObservers' => 0,
        'Training_TestRedirectToMain' => 0,
        'Training_Ui' => 0,
        'Vertex_Tax' => 1,
